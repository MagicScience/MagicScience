...
public class ModelWorkStationBlock extends ModelBase {
	// fields
	//fields
	ModelRenderer leg0;
	ModelRenderer leg1;
	...
	public void renderAll() {
		...
		leg2.render(0.0625F);
		leg3.render(0.0625F);
		bookLeft.render(0.0625F);
		bookStandLeveler.render(0.0625F);
		bookRight.render(0.0625F);
		bookStandBody.render(0.0625F);
		bookStandFoot.render(0.0625F);
		bookPageLeft.render(0.0625F);
		desk.render(0.0625F);
		wrenchBody.render(0.0625F);
		wrenchTopRight.render(0.0625F);
		wrenchTopLeft.render(0.0625F);
		wrenchMidBottom.render(0.0625F);
		wandBody.render(0.0625F);
	}
