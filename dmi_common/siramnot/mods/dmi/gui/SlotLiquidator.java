...
public class SlotLiquidator extends Slot
{
	...
	public SlotLiquidator(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
	{
	...
	protected void onCrafting(ItemStack par1ItemStack)
	{
		...
		if (!this.thePlayer.worldObj.isRemote)
		{
			...
			float var3 = RecipesLiquidator.liquidating().getExperience(par1ItemStack.itemID);
			int var4;
			if (var3 == 0.0F)
			{
				var2 = 0;
